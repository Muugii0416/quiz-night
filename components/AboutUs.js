    ...
    <Container className={'mb-44 scroll-mt-10'} id='about'>
      ...
      <div className='flex '>
        ...
        <div className='flex-1 ml-0 sm:ml-10 lg:ml-20'>
          <p >UB Quiz Night шинэ улирал үргэлжилж байна. 
          Шинэ улирлаас эхлэн бид МЯГМАР гараг бүр шинээр оролцож буй хүмүүстээ зориулсан ROOKIE QUIZ NIGHT эвэнтийг зохиож байна.
          Та бүхэн UB Quiz Night Group-ээс илүү дэлгэрэнгүй мэдээлэл аваарай.
          Оролцох хүсэлтэй хүн бүрт нээлттэй!
          </p>
